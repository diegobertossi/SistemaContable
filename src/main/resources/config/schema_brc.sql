-- Script de instalación de base de datos facturacion_db_brc
-- FacturaSoft v1.0
-- Uso: mysql -u root -p < schema_brc.sql

CREATE DATABASE IF NOT EXISTS facturacion_db_brc
CHARACTER SET utf8mb4
COLLATE utf8mb4_unicode_ci;

USE facturacion_db_brc;
